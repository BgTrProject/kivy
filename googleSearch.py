...
class GoogleSearch(Screen):
    ...
    def Search(self, search_keyword, site_url, file_name, start_date, end_date):
        ...
        driver = webdriver.Chrome('C:\\Users\\koray\\Desktop\chromedriver.exe') #kendi masaüstü yolunuzu verin
        ua = UserAgent()
